...
//
// Solidity: function BIND_PACKAGE() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_ALREADY_BOUND_TOKEN() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_DECIMALS_MISMATCH() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_REJECTED() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_SUCCESS() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_SYMBOL_MISMATCH() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_TIMEOUT() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_TOO_MUCH_TOKENHUB_BALANCE() constant returns(uint8)
...
//
// Solidity: function BIND_STATUS_TOTAL_SUPPLY_MISMATCH() constant returns(uint8)
...
//
// Solidity: function UNBIND_PACKAGE() constant returns(uint8)
...
//
// Solidity: function bindPackageRecord(bytes32 ) constant returns(uint8 packageType, bytes32 bep2TokenSymbol, address contractAddr, uint256 totalSupply, uint256 peggyAmount, uint8 bep20Decimals, uint64 expireTime)
...
//
// Solidity: function queryRequiredLockAmountForBind(string symbol) constant returns(uint256)
